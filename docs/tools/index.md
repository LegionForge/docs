...
| Tool | Purpose |
|---|---|
| [llm-valet](llm-valet.md) | Cross-platform LLM lifecycle manager. Auto-pauses Ollama when the system is under memory pressure or a game is running; resumes when the pressure subsides. |
| [mcp-probe](mcp-probe.md) | Connectivity and configuration advisor for MCP services you own or operate. Configures, connects, diagnoses, recommends — no scanning of unauthorized targets. |
